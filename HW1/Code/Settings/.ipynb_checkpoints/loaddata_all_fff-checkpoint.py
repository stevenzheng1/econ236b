...
def this_clean_all_fff(this_data,this_file,directory_int):
    '''
...
def this_load_all_fff(this_file,directory_raw,directory_int):
    '''
    ...
    try:
        ...
        this_result = this_clean_all_fff(this_data=this_data,
                                         this_file=this_file,
